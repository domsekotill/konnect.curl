...
@final
class EncodedFile[EncodingT: Encoding]:
	"""
	Combines decoding data with file path information
	"""

	def __init__(self, contents: EncodingT, path: Path) -> None:
		self.contents = contents
		self.path = path

	@classmethod
	def read[E: Encoding](
		cls: type[EncodedFile[E]],
		path: Path,
		encoding: type[E],
		/,
	...
	@staticmethod
	def write[E: Encoding](
		path: Path, contents: E, /, *, exists_ok: bool = False
	) -> EncodedFile[E]:
		"""
